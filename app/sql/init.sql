-- =============================================================================
-- Qlik Cloud Native App - Setup Script
-- =============================================================================
...
CREATE OR REPLACE STREAMLIT tools.qlik_agent_ui
    FROM '/streamlit'
    MAIN_FILE = 'streamlit_app.py';

GRANT USAGE ON STREAMLIT tools.qlik_agent_ui TO APPLICATION ROLE app_public;
